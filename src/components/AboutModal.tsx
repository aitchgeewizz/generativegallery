 ...
 * read it without leaving the canvas.
 */
export const AboutModal = ({ open, onClose }: AboutModalProps) => {
  ...
  return (
    <AnimatePresence>
      {open && (
        <motion.div
          className="fixed inset-0 z-50 flex items-start md:items-center justify-center overflow-y-auto bg-black/80 backdrop-blur-sm"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
        ...
        >
          <motion.article
            className="relative w-full max-w-2xl mx-4 my-12 md:my-16 p-8 md:p-12 rounded-lg bg-[#0a0a0a] border border-white/10 text-white/80 font-display"
          ...
          >
            <button
              onClick={onClose}
              aria-label="Close"
              className="absolute top-4 right-4 w-9 h-9 flex items-center justify-center rounded-full text-white/40 hover:text-white/80 hover:bg-white/[0.06] transition-colors"
            >
            ...
            <h2 className="text-3xl md:text-4xl tracking-tight text-white/90 leading-none">
              Slower. <span className="italic">Stranger.</span>
            </h2>

            <p className="mt-6 text-sm md:text-base leading-relaxed text-white/70">
              Most design inspiration online is a firehose. This is the opposite. Slower. Stranger.
            ...
            <h3 className="mt-10 text-xs uppercase tracking-[0.2em] text-white/40">Why this exists</h3>
            ...
            <h3 className="mt-10 text-xs uppercase tracking-[0.2em] text-white/40">What it feels like</h3>
            <p className="mt-3 text-sm md:text-base leading-relaxed text-white/65">
              The experience I&rsquo;m trying to recreate is awe. The moment in a gallery when you stop in front of something and just go wow. A colour. A composition. A choice someone made 90 years ago that still holds up.
            </p>
            <p className="mt-3 text-sm md:text-base leading-relaxed text-white/65">
            ...
            <h3 className="mt-10 text-xs uppercase tracking-[0.2em] text-white/40">What this is not</h3>
            <ul className="mt-3 text-sm md:text-base leading-relaxed text-white/65 space-y-1.5">
            ...
            <p className="mt-12 text-xs text-white/30 tracking-wide">
              Built by <a href="https://www.linkedin.com/in/hannahgibson/" target="_blank" rel="noopener noreferrer" className="text-white/50 hover:text-white/80 underline-offset-4 hover:underline transition-colors">Hannah Gibson</a>. Artwork courtesy of the Art Institute of Chicago, Cooper Hewitt Smithsonian Design Museum, and the Harvard Art Museums.
            </p>
          </motion.article>
        </motion.div>
      )}
